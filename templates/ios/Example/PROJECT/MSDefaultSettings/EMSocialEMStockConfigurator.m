...
@implementation EMSocialEMStockConfigurator
...
- (NSString*)sinaWeiboURLScheme {
    return [@"wb" stringByAppendingString:[self sinaWeiboConsumerKey]];
}

- (NSString *)wechatURLScheme {
    return [self tencentWeixinAppId];
}
