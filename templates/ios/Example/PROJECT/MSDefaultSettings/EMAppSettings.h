...
#import "EMSettingsCondition.h"
    ...
    #import <EMPayKit/EMAppPaySettings.h>
    #import "EMAppPayConfiurator.h"
#endif /* __MODULE_PAY_ENABLED__ */
...
#if __MODULE_PAY_ENABLED__
@property (nonatomic, strong) EMPayDefaultConfiurator *payDefaultConfiurator;
#endif

#if __MODULE_INFO_ENABLED__
@property (nonatomic, assign) BOOL isVIPInfoExpiredShowed;
#endif
